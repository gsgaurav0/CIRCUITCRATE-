...
export const Component = () => {
  return (
    <section className="grid place-content-center gap-2 bg-black w-full min-h-screen text-white py-20">
      <FlipLink href="https://x.com/circuit_crate">Twitter</FlipLink>
      <FlipLink href="https://www.linkedin.com/company/circuitcrate1/">Linkedin</FlipLink>
      <FlipLink href="https://github.com/circuitcrate">Github</FlipLink>
      <FlipLink href="https://www.instagram.com/circuitcrate_">Instagram</FlipLink>
    </section>
  );
};
