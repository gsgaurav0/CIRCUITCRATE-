...
const Workshops = () => {
    ...
    useEffect(() => {
        const loadWorkshops = async () => {
            const data = await fetchFromSupabase('workshops');
        ...
        <section id="workshops" className="workshops-section">
            <div className="container mx-auto px-4">
                    ...
                    {workshops.map((workshop) => (
                        <div key={workshop.id} className="workshop-card">
                            <div className="workshop-img-wrapper">
                                <img src={resolveImageUrl(workshop.image)} alt={workshop.title} className="workshop-img" />
                ...
                <div className="cta-box">
                    ...
                    <Link to="/contact?subject=partner" className="cta-btn-outline">
                        Partner With Us
                    </Link>
                </div>
            </div>
