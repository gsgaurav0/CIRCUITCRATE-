...
export const LogoLoop = memo(
    ({
        ...
        const renderLogoItem = useCallback(
            (item, key) => {
                ...
                const content = isNodeItem ? (
                    <span
                        className="logoloop-node-content"
        ...
        const logoLists = useMemo(
            () =>
                Array.from({ length: copyCount }, (_, copyIndex) => (
                    <ul
                        className={cx('logoloop-list', isVertical && 'list-vertical')}
                        key={`copy-${copyIndex}`}
                        role="list"
        ...
        return (
            ...
            >
                {fadeOut && (
                    <div className="logoloop-fade-overlay">
                        {isVertical ? (
                            <>
                ...
                <div
                    className={cx(
                        'logoloop-track',
                        isVertical ? 'track-vertical' : 'track-horizontal'
                    )}
                    ref={trackRef}
                    onMouseEnter={handleMouseEnter}
                    onMouseLeave={handleMouseLeave}
